    ...
    <>
      <header className="text-gray-600 body-font max-sm:px-4 w-full">
        <div className="container mx-auto flex flex-wrap h-11 items-center justify-between px-4">
          ...
          >
            <span className="absolute mx-auto flex border w-fit bg-gradient-to-r blur-xl from-ai-blue via-ai-purple to-ai-pink bg-clip-text md:text-xl box-content font-bold text-transparent text-center select-none">
              GJ, WORLD
            </span>
